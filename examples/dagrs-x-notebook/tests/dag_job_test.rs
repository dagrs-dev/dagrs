...
use dagrs_x_notebook::{yaml_parser::YamlParser, Parser};

const PARSER: YamlParser = YamlParser;
...
//         .unwrap()
//         .start();
//     assert!(matches!(res, Err(Error::LoopGraph)))
// }

// #[test]
// fn yaml_task_self_loop_graph() {
//     let res = Graph::with_yaml("tests/config/self_loop_error.yaml", HashMap::new())
//         .unwrap()
//         .start();
